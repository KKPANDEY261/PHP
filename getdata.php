    ...
    <div class="container,card mt-5">
     ...
     <div class="card-body">
      ...
      while($row = mysqli_fetch_assoc($result))
      {
        ...
        <td>
                <button class="btn btn-primary"><a href="update.php?updateid='<?php echo $row['sl_no'];?>'" class="text-light">Update</a></button>
                <button class="btn btn-danger"><a href="delete.php?deleteid='<?php echo $row['sl_no'];?>'" class="text-light">Delete</a></button>
            </td>
      </tr>
      <?php
      }
