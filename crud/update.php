...
if(isset($_POST['submit'])){
    ...
    if(mysqli_num_rows($check_query) > 0){
        ...
        $insert_query = "UPDATE csa SET name='$name',email='$email',password='$password_hash',confirm_password='$cpassword',dob='$dob',gender='$gender',address='$address', city='$city', state='$state', country='$country', zip_code='$zipcode', phone_number='$phone_number' WHERE `sl.no.`=$id";
